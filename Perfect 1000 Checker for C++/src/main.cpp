...
void perfect_1000(){
        ...
        if(choice == "C" || choice == "CHECK"){
            ...
            cout << endl << "How many calculations should I do? (1000/sec on average PC) (Recommended: 3000-6000 Attempts): ";
            ...
            for(int i = 0; i <= 8; i++){
                ...
                cout << ">>> ";
                cin >> num;
                if (num != "9" && num != "8" && num != "7" && num != "6" && num != "5" && num != "4" && num != "3" && num != "2" && num != "1" && num != "0"){
                    cout << endl << "You must enter either 0, 1, 2, 3, 4, 5, 6, 7, 8 or 9." << endl;
                    Sleep(1000);
                    i--;
                }
                else{
            ...
            cout << endl << endl << "********" << endl << "NUMBERS:" << endl << "********" << endl << endl;
            while((number1 + number2 + number3) != 1000){
                ...
                if((number1 + number2 + number3) == 1000){
                    cout << endl << endl << "Number One: " << number1 << endl << "Number Two: " << number2 << endl << "Number Three: " << number3 << endl << "Total: " << (number1 + number2 + number3) << endl;
                    perfect_1000();
                }
                else{
                    calculations++;
            ...
            cout << endl << "\"Thank you for using my perfect thousand checker!\" -Kyle James Catterall." << endl;
            Sleep(2000);
            exit(0);
        }
        else{
...
int main()
{
    cout << endl << "*******************************************" << endl << "Perfect 1000 Checker - Kyle James Catterall" << endl << "*******************************************" << endl;
    perfect_1000();
    return 0;
}
